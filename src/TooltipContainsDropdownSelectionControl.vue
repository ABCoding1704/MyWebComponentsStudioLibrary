...
<template>
    ...
    <div class="tooltip-selection-container">
			<div class="bubble">
				<div class="tooltip-container">            
						<div class="tooltip-content">
							...
							<div class="selection-liste">
									<ul class="liste">
											<template src="datasource-liste in option" >
													<li class="eintrag-liste">
															<div class="eintrag">
																	<div class="eintrag-icon-container">
                                                                        <img src="../../../assets/Icons/pin.png" class="eintrag-icon-file" @mouseover="ShowToolTip(this)" @mousedown="HideToolTip(this)"/>
																	</div>
																	<div class="eintrag-text" @mouseover="ShowToolTip(this)" @mousedown="HideToolTip(this)">
                                                                        <img src="../../../assets/Icons/pin.png" class="eintrag-icon-file" @mouseover="ShowToolTip(this)" @mousedown="HideToolTip(this)"/>
																	</div>
																	<div class="eintrag-funtion-symbol" @mouseover="ShowToolTip(this)" @mousedown="HideToolTip(this)">
                                                                        <img src="../../../assets/Icons/pin.png" class="eintrag-icon-file" @mouseover="ShowToolTip(this)" @mousedown="HideToolTip(this)"/>
																	</div>
															</div>
													</li>
...
// .tooltip-selection-container:hover {
